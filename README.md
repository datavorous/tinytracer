...
The image generated will be of `.ppm` format, inside the `output` folder.
...
Check out [explained.md](media/explained.md) for some rudimentary explanation from my side.
